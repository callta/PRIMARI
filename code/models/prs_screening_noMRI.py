...
class PrsScreeningNoMRI(Save):
    ...
    def _run_model(self, params, a_risk, od_by_risk):
        ...
        for year in np.arange(55, 70):
            ...
            if od_by_risk==False:
                # Baseline analyses
                overdiagnosis_sc = pca_incidence_screened * params.p_overdiagnosis_psa_nomri.T[:, year-45:]
                overdiagnosis_nos_sc = pca_incidence_nos_sc_screened * params.p_overdiagnosis_psa_nomri.T[:, year-45:]

            elif od_by_risk==True:
                # Sensitivity analyses - overdiagnosis varying inversely by polygenic risk doi:10.1038/gim.2014.192
                overdiagnosis_sc = pca_incidence_screened * params.p_overdiagnosis_psa_nomri.T[:, year-45:] * (1/a_risk.loc[year, 'rr_high'])
                overdiagnosis_nos_sc = pca_incidence_nos_sc_screened * params.p_overdiagnosis_psa_nomri.T[:, year-45:] * (1/a_risk.loc[year, 'rr_low'])
            ...
            # PSA testing in non-screened arms
            ...
            # PSA testing in screened arms
            if year > 54:
                # Healthy individuals eligible for screening
                ...
                n_psa_tests_post_screening_prs = (pca_incidence_post_screening / params.p_biopsy_ns[:, year-45:]) * params.n_psa_tests[:, year-45:]
                ...
                # Assuming all cancers are clinically detected in the post-screening phase
                n_psa_tests_nos_sc_post_screening_prs = (pca_incidence_nos_sc_post_screening / params.p_biopsy_ns[:, year-45:]) * params.n_psa_tests[:, year-45:]
            ...
            # MRI - screened arms
            if year < 55:
                n_mri_sc_prs = pca_incidence_sc * params.mri_biopsy_first[:, year-45:]
                cost_mri_sc_nodiscount_prs = (n_mri_sc_prs
                                              * np.array([params.cost_mri]).T
                                              * params.relative_cost_clinically_detected[:, year-45:])

                n_mri_nos_sc_prs = pca_incidence_nos_sc * params.mri_biopsy_first[:, year-45:]
                ...
                n_mri_screened_prs = pca_incidence_screened * params.mri_biopsy_first[:, year-45:]
                cost_mri_screened_nodiscount_prs = n_mri_screened_prs * np.array([params.cost_mri]).T

                n_mri_post_screening_prs = pca_incidence_post_screening * params.mri_biopsy_first[:, year-45:]
                ...
                n_mri_nos_sc_screened_prs = pca_incidence_nos_sc_screened * params.mri_biopsy_first[:, year-45:]
                cost_mri_nos_sc_screened_nodiscount_prs = n_mri_nos_sc_screened_prs * np.array([params.cost_mri]).T

                # Assuming all cancers are clinically detected in the post-screening phase
                n_mri_nos_sc_post_screening_prs = pca_incidence_nos_sc_post_screening * params.mri_biopsy_first[:, year-45:]
                ...
                cost_mri_nos_sc_nodiscount_prs = cost_mri_nos_sc_screened_nodiscount_prs + cost_mri_nos_sc_post_screening_nodiscount_prs
            ...
            n_mri_ns_prs = pca_incidence_ns * params.mri_biopsy_first[:, year-45:]
            ...
            n_mri_nos_prs = pca_incidence_nos * params.mri_biopsy_first[:, year-45:]
            cost_mri_nos_nodiscount_prs = (n_mri_nos_prs * np.array([params.cost_mri]).T) * params.relative_cost_clinically_detected[:, year-45:]
            ...
            # Biopsies - screened arms
            if year > 54:
                # Screen-detected cancers
                n_biopsies_screened_prs = pca_incidence_screened / params.p_biopsy_sc[:, year-45:]
                cost_biopsy_screened_nodiscount_prs = n_biopsies_screened_prs * params.cost_biopsy[:, year-45:]

                # Assuming all cancers are clinically detected in the post-screening phase
                n_biopsies_post_screening_prs = pca_incidence_post_screening / params.p_biopsy_ns[:, year-45:]
                ...
                n_biopsies_nos_sc_screened_prs = pca_incidence_nos_sc_screened / params.p_biopsy_sc[:, year-45:]
                cost_biopsy_nos_sc_screened_nodiscount_prs = n_biopsies_nos_sc_screened_prs * params.cost_biopsy[:, year-45:]

                # Assuming all cancers are clinically detected in the post-screening phase
                n_biopsies_nos_sc_post_screening_prs = pca_incidence_nos_sc_post_screening / params.p_biopsy_ns[:, year-45:]
                ...
                cost_biopsy_nos_sc_nodiscount_prs = cost_biopsy_nos_sc_screened_nodiscount_prs + cost_biopsies_nos_sc_post_screening_nodiscount_prs

            elif year < 55:
                n_biopsies_sc_prs = pca_incidence_sc / params.p_biopsy_ns[:, year-45:]
                cost_biopsy_sc_nodiscount_prs = (n_biopsies_sc_prs
                                                 * params.cost_biopsy[:, year-45:]
                                                 * params.relative_cost_clinically_detected[:, year-45:])

                n_biopsies_nos_sc_prs = pca_incidence_nos_sc * params.p_biopsy_ns[:, year-45:]
            ...
            n_biopsies_ns_prs = pca_incidence_ns / params.p_biopsy_ns[:, year-45:]
            ...
            n_biopsies_nos_prs = pca_incidence_nos / params.p_biopsy_ns[:, year-45:]
            ...
            if year > 54:
                ...
                cost_staging_sc_nodiscount_prs = cost_staging_screened_nodiscount_prs + cost_staging_post_screening_nodiscount_prs
                ...
                cost_staging_nos_sc_nodiscount_prs = cost_staging_nos_sc_screened_nodiscount_prs + cost_staging_nos_sc_post_screening_nodiscount_prs
